...
export default function HeroSection() {
    ...
    return (
        ...
        <div className="flex flex-col-reverse md:flex-row shadow-sm items-center gap-8 lg:gap-24 mt-10  lg:mt-8 ">
            ...
            <div className='flex flex-col  gap-2'>
                <div className="text-2xl xlg:text-3xl 2xl:text-4xl  font-inter font-semibold  2xl:leading-[44px] leading-7 my-5 ">
                    ...
                    <br />
                    <span className="text-labelColor-500">Proctoring </span>
                    <span className="text-smallHeading-500">and </span>
                    <span className="text-labelColor-500">Creation Platform </span>
                </div>
